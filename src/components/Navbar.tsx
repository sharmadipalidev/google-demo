...
export default function Navbar() {
 ...
 className="absolute top-full left-0 w-full bg-white/95 backdrop-blur-md shadow-lg border-t border-black/5 flex flex-col items-center py-8 gap-6 md:hidden"
 >

 {isSignedIn ? (
 <Link
 href="/gmail"
 className="bg-[#1a1a1a] text-white px-6 py-3 rounded-xl font-semibold hover:bg-black transition-colors flex items-center gap-2"
 ...
 <SignInButton mode="modal">
 <button className="bg-[#1a1a1a] text-white px-6 py-3 rounded-xl font-semibold hover:bg-black transition-colors flex items-center gap-2">
 Go to Dashboard <ChevronRight className="w-4 h-4" />
 </button>
 </SignInButton>
 )}
