...
export default function Footer() {
  return (
    <footer className="bg-white/30 dark:bg-black/30 backdrop-blur-md border-t border-black/5 dark:border-white/5 mt-32 relative z-10 transition-colors">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0 flex items-center gap-2 justify-center md:justify-start">
          <svg
            ...
            className="text-[#1a1a1a] dark:text-white transition-colors"
          >
            <path
