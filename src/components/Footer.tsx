...
export default function Footer() {
 return (
 <footer className="bg-white/30 backdrop-blur-md border-t border-black/5 mt-32 relative z-10 transition-colors">
 <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
 <div className="flex justify-center space-x-6 md:order-2">
 {/* Social icons */}
 <Link href="#" className="text-[#8e8e8e] hover:text-[#1a1a1a] transition-colors">
 ...
 <p className="text-center text-xs leading-5 text-[#8e8e8e] transition-colors">
